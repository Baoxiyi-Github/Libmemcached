...
typedef enum {
  MEMCACHED_DISTRIBUTION_MODULA,//默认
  MEMCACHED_DISTRIBUTION_CONSISTENT,//一致性hash
...
typedef enum {
  ...
  MEMCACHED_BEHAVIOR_TCP_NODELAY,//不组包，直接发
  ...
  MEMCACHED_BEHAVIOR_BINARY_PROTOCOL,//启用二进制协议
  MEMCACHED_BEHAVIOR_SND_TIMEOUT,
  MEMCACHED_BEHAVIOR_RCV_TIMEOUT,
  MEMCACHED_BEHAVIOR_SERVER_FAILURE_LIMIT,//尝试失败n次后踢出server
  MEMCACHED_BEHAVIOR_IO_MSG_WATERMARK,
  MEMCACHED_BEHAVIOR_IO_BYTES_WATERMARK,
  MEMCACHED_BEHAVIOR_HASH_WITH_PREFIX_KEY,
  MEMCACHED_BEHAVIOR_NOREPLY//不关心结果
} memcached_behavior;
