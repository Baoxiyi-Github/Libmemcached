...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	ChangeLog INSTALL NEWS THANKS TODO config/config.guess \
...
CONFIG_HEADER = $(top_builddir)/libmemcached/libmemcached_config.h
CONFIG_CLEAN_FILES =
SOURCES =
DIST_SOURCES =
...
STRIP = strip
VERSION = 0.26
abs_builddir = /Baocf/Libmemcached
abs_srcdir = /Baocf/Libmemcached
